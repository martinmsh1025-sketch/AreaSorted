# AreaSorted - Next.js Project Scaffold v1
...
- make `provider` the primary protected business portal
- keep `cleaner` or workforce routes secondary to the provider-company model
