# AreaSorted - Cleaner Scoring Policy v1
...
- This document applies to secondary cleaner or workforce operations only
- It does not define the primary provider-company marketplace model or provider portal architecture
