...
/**
 * C-14 FIX: Error boundary for the booking status/confirmation flow.
      ...
      <div className="w-full max-w-md space-y-6 text-center">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            We couldn&apos;t load your booking details. Please try again or check your bookings from your account.
          </p>
        </div>
